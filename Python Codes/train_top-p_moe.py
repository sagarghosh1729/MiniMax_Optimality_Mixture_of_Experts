...
def main():
    ...
    results_df.to_csv(f".../Mixture of Experts/Simulations/Results_CSV/Top_P_Case/in{d_in}_out{d_out}.csv", index=False)
    ...
    plt.grid()
    plt.savefig(f'.../Mixture of Experts/Simulations/New_Figures/Top_P_case/in{d_in}_out{d_out}.png', dpi=300, bbox_inches='tight')
    plt.show()
